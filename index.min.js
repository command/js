...
function () {
  ...
  _createClass(CommandAPI, [{
    ...
    value: function _request(method, path) {
      var body = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}; // NOTE: https://api.oncommand.io is dynamically swapped to https://api.oncommand.io in /release.js when releasing a new version. Leave as-is for local dev.

      (0, _axios["default"])({
        method: method,
        url: "https://api.oncommand.io/v1".concat(path),
        headers: {
